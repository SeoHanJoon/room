...
export const TOGGLE_ITEM = 'board/TOGGLE_ITEM';
  ...
  mainBoard: [
    {
      ...
      content:
        '코끼리는 정말 코를 손처럼 자유자재로 써요.\n노래 가사처럼 과자도 집어먹고, 물건을 움직이기도 하고,\n또 물을 뿌려 목욕을 하기도 해요. 심지어 사랑 고백도 한대요!\n\n코끼리 코는 정말 만능이군요!',
      img:
    ...
    },
    {
      ...
      content:
        '곧 다가올 여름방학! 어디론가 훌쩍 떠날 여행 계획이 있으신가요? 가까운 중국부터 머나먼 유럽까지 당장 떠나고 싶은 해외 여행지가 수두룩하지만 현실은 ‘#해외여행’ 만 열심히 검색하는 나 자신을 볼 수 있을 텐데요. ㅠ.ㅠ\n\n비용적으로나 시간적으로나 가기 어려운 해외 여행지를 국내에서 즐길 수 있다는 사실! 알고 계신가요? 오늘은 해외 여행을 떠나지 못하는 여러분을 위해 한국인지, 해외인지 헷갈릴 정도로 이색적인 해외 테마 마을들을 소개해 볼게요!',
      img:
    ...
    },
    {
      ...
      content:
        "Salut! (쌀뤼! 안녕!)\n\n이 말은 프랑스어로 만났을 때 하는 다양한 인사 중 하나야.\n흔히들 아는 인사 'Bonjour'는 모르는 사람끼리도 가볍게 하는 인사지만,\nSalut는 가까운 사람들끼리만 하는 인사야.",
      img:
    ...
    },
    {
      ...
      content:
        '이번 시간에는 미디어 아트 프로그램을 만들어보려 해요.\n마우스 클릭만으로 꾸밀 수 있게요!\n\n처음 소프트웨어를 접한 사람들도 쉽게 다룰 수 있는 블록형 프로그래밍 언어,\n엔트리(playentry.org)를 이용해 프로그램을 만들어 보겠습니다.',
      img:
...
export default handleActions(
  {
    [TOGGLE_ITEM]: (state, action) => produce(state, (draft) => {
      const item = draft.mainBoard.find(items => items.id === action.payload);
      item.bools = !item.bools;
    }),
  },
  initialSatate,
);
